...
através do uso de preprocessador de C/C++ através de macros. Uma simples
...
duas keywords possuem diferentes significados em casos seprados, como typename
ser usado em tipos dependentes e ser recomendado usar class para classes aninhadas.

*** TODO Preprocessor Solution
